...
class Environment(object):
    ...
    # 1.0, 3.0, 11.0, 17.0, 23.0, 28.0, 30.0, 29.0, 26.0, 18.0, 10.0, 3.0
    # 1.0, 5.0, 7.0, 10.0, 11.0, 20.0, 23.0, 24.0, 22.0, 10.0, 5.0, 1.0
    def __init__(self, optimal_temperature = (18.0, 24.0), initial_month = 0, initial_number_users = 10, initial_rate_data = 60):
        self.monthly_atmospheric_temperatures = [1.0, 3.0, 11.0, 17.0, 23.0, 28.0, 30.0, 29.0, 26.0, 18.0, 10.0, 3.0]
        ...
        self.max_number_users = 80 #per minute
        self.max_update_users = 5
        self.min_rate_data = 20 #number of servicce calls per minute
        self.max_rate_data = 100
